...
// --- Import your useFetchSkinType hook ---
import { useFetchSkinType } from "@/hooks/SkinType/useFetchSkinType";

import { skinTypeColumn } from "../columns/skinTypeColumns";
            ...
            <div className="mx-auto bg-white px-8 py-15 pt-4">
              <div className="mt-3 mb-6 flex justify-between">
                ...
                <div className="bg-primary hover:bg-primary/90 rounded-lg text-white">
                  <Button className="cursor-pointer p-5" onClick={() => navigate("/admin/create-skin-type")}>

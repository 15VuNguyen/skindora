        ...
        <div className="flex gap-2">
          ...
          <div>
            <Button
              variant="default"
              onClick={() => {
                navigate(`/admin/${id}/update-product-type`);
              }}
            >
      ...
      <Card className="shadow-lg">
        <CardHeader className="border-b pb-4">
          <CardTitle className="text-3xl text-gray-900">
            <Typography className="">{productType.option_name}</Typography>
          </CardTitle>
          <CardDescription className="text-md mt-1 text-gray-600">
            Size ID: <span className="font-mono text-sm">{productType._id}</span>
          </CardDescription>
        </CardHeader>
